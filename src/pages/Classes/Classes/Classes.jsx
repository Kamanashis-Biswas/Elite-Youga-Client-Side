...
const Classes = () => {
    ...
    const addClass = async ({ classId }) => {
        const resp = await fetch('http://localhost:5000/set-class', { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ userId: localStorage.getItem('userId'), classId: classId }) });
